...
import static com.paxovision.db.Change.*;
...
public class Changes extends AbstractDbElement<Changes> {
   ...
   * Constructor.
   * 
   * @param source The {@link org.assertj.db.type.Source} to connect to the database (must be not {@code null}).
  ...
  /**
   * Returns the list of {@link org.assertj.db.type.Table}.
   * @return The list of {@link org.assertj.db.type.Table}.
   */
  ...
  /**
   * Sets the {@link org.assertj.db.type.Request}.
   * 
   * @param request The {@link org.assertj.db.type.Request}.
   * @return {@code this} actual instance.
   */
   ...
   * 
   * @return {@code this} actual instance.
   * @throws DBException If the start point is not set
   */
  public Changes setEndPointNow() {
    if (requestAtStartPoint == null && tablesAtStartPointList == null) {
      throw new DBException("Start point must be set before");
    }
   ...
   * @throws DBException If the changes are on all the tables and if the number of tables change between the
  ...
  public List<Change> getChangesList() {
    if (changesList == null) {
      if (requestAtEndPoint == null && tablesAtEndPointList == null) {
        throw new DBException("End point must be set before");
      }
