...
public class Values {
    ...
    if (expected instanceof BigInteger) {
      ...
      if (object instanceof BigInteger) {
        ...
        try {
          ...
          throw new DBException("Expected <%s> can not be compared to a BigInteger (<%s>)", expected, object);
        }
      }
    ...
    // change the value in BigDecimal to compare
      ...
      if (object instanceof BigDecimal) {
        ...
        try {
          ...
          throw new DBException("Expected <%s> can not be compared to a BigDecimal (<%s>)", expected, object);
        }
      }
   ...
   * @throws DBException If it is not possible to compare {@code date} to {@code expected}.
   */
  private static boolean areEqual(Date date, String expected) {
    try {
      ...
      throw new DBException("Expected <%s> is not correct to compare to <%s>", expected, date);
    }
    return false;
  }
   ...
   * @throws DBException If it is not possible to compare {@code time} to {@code expected}.
   */
  private static boolean areEqual(Time time, String expected) {
    try {
      ...
      throw new DBException("Expected <%s> is not correct to compare to <%s>", expected, time);
    }
    return false;
  }
   ...
   * otherwise.
   * @throws DBException If it is not possible to compare {@code timestamp} to {@code expected}.
   */
  private static boolean areEqual(Timestamp timestamp, String expected) {
    try {
      ...
      throw new DBException("Expected <%s> is not correct to compare to <%s>", expected, timestamp);
    }
    return false;
  }
   ...
   * @throws DBException   If it is not possible to compare {@code number} to {@code expected}.
   */
  private static boolean areEqual(Number number, String expected) {
    try {
      ...
      throw new DBException("Expected <%s> is not correct to compare to <%s>", expected, number);
    }
    return false;
  }
   ...
   * @throws NullPointerException if {@code expected} is {@code null}.
   * @throws DBException   If {@code value} is a {@code Number} and it is not possible to compare to
   *                              {@code expected}.
   */
   ...
   * @throws DBException If it is not possible to compare {@code UUID} to {@code expected}.
   * @since 1.1.0
   */
  public static boolean areEqual(UUID value, String expected) {
    ...
    try {
      ...
      throw new DBException("Expected <%s> is not correct to compare to <%s>", expected, value);
    }
  ...
  public static int compare(Value value, Number expected) {
    ...
    throw new DBException("Expected <%s> can not be compared to a Number (<%s>)", expected, object);
  }
   ...
   * @throws DBException If the length of the two arrays are different.
   */
